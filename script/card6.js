document.getElementById("six-card-btn").addEventListener("click", function(){
    // step no 1
    ...
    const sixCardTitle = document.getElementById("six-card-title").innerText;
    ...
    function updateTime (){
        ...
        p.innerText = `You have Complete The Task ${sixCardTitle} at ${timeString}`;
    }
    div.appendChild(p);
